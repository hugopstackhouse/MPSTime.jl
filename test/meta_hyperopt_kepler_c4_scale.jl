...
if nprocs() == 1
    addprocs(84; env=e, exeflags="--heap-size-hint=2G", enable_threaded_blas=false)
end
...
for inst in 2:5
    rs_f = jldopen("Folds/Kepler/c4_folds_per_inst.jld2", "r");
    ...
    # 0.22382542363624128
    # 0.1972986806310512
    @save "kepc4_rand_ns_$inst.jld2" res
    # 20 iter benchmarks 
end
