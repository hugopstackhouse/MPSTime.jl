...
if nprocs() == 1
    addprocs(5; env=e, exeflags="--heap-size-hint=2.4G", enable_threaded_blas=false)
end
...
res = MPSTime.evaluate(
    ...
    opts0=MPSOptions(; verbosity=-5, log_level=-1, sigmoid_transform=true, nsweeps=10),
    tuning_abstol=1e-5, 
    tuning_maxiters=250,
